...
public class Application extends android.app.Application {
    ...
    public void onCreate() {
        ...
        //PushService.setDefaultPushCallback(this, MainActivity.class, R.drawable.notification);

        ParsePush.subscribeInBackground("", new SaveCallback() {
            @Override
            public void done(ParseException e) {
                if (e == null) {
                    Log.d(APPTAG, "successfully subscribed to the broadcast channel.");
                } else {
                    Log.e(APPTAG, "failed to subscribe for push", e);
                }
            }
        });
    }
